...
# Track the Vote Percent and Count in Each County 
winning_county = ""
...
with open(file_to_load) as election_data:
    ...
    for row in file_reader:
        ...
        candidate_votes[candidate_name] += 1
          ...
          # If the county does not match any existing county then  add the
          # the  list.
        county_name = row[1]
...
with open(file_to_save, "w") as txt_file:
    ...
    txt_file.write(election_results)
     ...
     #Finding Votes Count for Each County 
    print("") 
    print("County Votes:")
    for county_name in county_votes :
        ...
        txt_file.write(county_results)
          #Finding Largest County Turnout :
